    ...
    internal class TestDataConfiguration
    {
        public static void ConfigureSeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
              ...
              WithAudit(new Product { Id = 6, Name = "Four Cheese & Pesto", Description = "Mozzarella, feta, cheddar, romano, and basil pesto sauce topped with diced tomatoes.", PhotoPath = "pizzaImages/6.jpg", Price = 15, CategoryId = Category.ChicagoDeepDishPizza }),
